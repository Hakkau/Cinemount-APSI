...
Public Class KursiBr
    Dim connectionString As String = "Data Source=marcel-pc\sqlexpress;Initial Catalog=cinema;Integrated Security=True" ' Replace with your actual connection string
