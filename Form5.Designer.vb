...
Partial Class Form5
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBox5.Text = "Cast: Margot Robbie, Ryan Gosling, Will Ferell, Emma Mackey, Simu Liu, Kingsley B" &
    "en-Adir"
        '
        'TextBox4
        '
        ...
        Me.TextBox4.Text = "Director : Greta Gerwig"
        '
        'TextBox3
        '
